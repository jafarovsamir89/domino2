...
- There were 3 failed/stuck rooms.
...
* **Rooms Completed**: 3
* **Rooms Failed**: 3
* **Average Room Start Time**: 915 ms
* **Average Match Duration**: 1200294 ms

## API & WebSocket Latencies
* **Average Auth/Profile Latency**: 1466 ms
* **Average Game Token Mint Latency**: 418 ms
...
* **Total Coins Won (Prizes Distributed)**: 3956040
