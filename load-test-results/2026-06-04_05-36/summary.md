...
* **Rooms Completed**: 4
* **Rooms Failed**: 0
* **Average Room Start Time**: 1096 ms
* **Average Match Duration**: 187360 ms

## API & WebSocket Latencies
* **Average Auth/Profile Latency**: 814 ms
* **Average Game Token Mint Latency**: 299 ms
...
## Economy Report
* **Total Coins Spent (Stakes Reserved)**: 4180
* **Total Coins Won (Prizes Distributed)**: 3420
